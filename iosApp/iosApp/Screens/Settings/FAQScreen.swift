        ...
        List {
                ...
                FAQCategoryView(
                    ...
                    items: [
                        ...
                        FAQItem(
                            ...
                            answer: "Cashiro only accesses data you manually enter. The app does not access any other app data on your device."
                        ),
                    ]
                )
            }
            ...
            Section {
                VStack(spacing: AppSpacing.md) {
                    ...
                    Button {
                        if let url = URL(string: "https://github.com/nicekid1/cashiroai-tracker/issues/new/choose") {
