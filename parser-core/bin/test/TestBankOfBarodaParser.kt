...
class BankOfBarodaParserTest {
    @Test
    fun `test Bank of Baroda Parser comprehensive test suite`() {
        ...
        val testCases = listOf(
            ...
            ParserTestCase(
                ...
                expected = ExpectedTransaction(
                    ...
                    currency = "INR",
                    type = com.ritesh.parser.core.TransactionType.INCOME,
            ...
            ParserTestCase(
                ...
                expected = ExpectedTransaction(
                    amount = BigDecimal("1500.00"),
                    currency = "INR",
                    type = com.ritesh.parser.core.TransactionType.CREDIT,
                    merchant = null,
                    accountLast4 = "1234",
