...
import com.ritesh.cashiro.data.database.dao.CategoryBudgetLimitDao
...
import com.ritesh.cashiro.data.database.entity.BudgetGroupType
import com.ritesh.cashiro.data.database.entity.BudgetPeriodType
import com.ritesh.cashiro.data.database.entity.BudgetWithCategories
...
class BudgetGroupRepository @Inject constructor(
    ...
    fun buildSummary(
        ...
        allTransactions: List<com.ritesh.cashiro.data.database.entity.TransactionWithSplits>,
        daysElapsed: Int,
        daysRemaining: Int,
        currency: String
    ...
    suspend fun migrateFromOldBudget(
        oldLimit: BigDecimal?,
        oldCategoryLimits: List<com.ritesh.cashiro.data.database.entity.CategoryBudgetLimitEntity>,
        currency: String
    ) {
