...
import com.ritesh.cashiro.data.database.entity.CategoryBudgetLimitEntity
...
data class MonthlyBudgetSpendingRaw(
    ...
    val allTransactions: List<com.ritesh.cashiro.data.database.entity.TransactionWithSplits>,
    val prevTransactions: List<com.ritesh.cashiro.data.database.entity.TransactionWithSplits>,
    val daysElapsed: Int,
    val daysRemaining: Int
)
